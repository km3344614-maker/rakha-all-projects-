...
function isPopupMouseFrozen() {
  if (typeof document === 'undefined') return false;
  const b = document.body;
  return b.classList.contains('sa-dd-open') || b.classList.contains('sa-modal-open');
}
...
`;
 ...
 this.lastUserInteraction = performance.now() - 60000;
 Mouse.onInteract = () => {
